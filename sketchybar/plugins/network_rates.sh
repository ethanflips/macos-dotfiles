...
read initial_rx initial_tx < <(netstat -ibn | awk -v iface="$INTERFACE" '$1 == iface {print $7, $10}')
sleep 1
read final_rx final_tx < <(netstat -ibn | awk -v iface="$INTERFACE" '$1 == iface {print $7, $10}')
